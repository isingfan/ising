...
nmceq=1000000 #number of states that are counted for expectation value
Tmin=2.0
Tmax=2.50
dT=0.25
...
for T in Tarray:
    ...
    if T==Tarray[0]:
        ...
        filesuffix="D:/WPy64-31090/notebooks/file" +"_Tmin_"+ str(Tmin) +"_Tmax_"+ str(Tmax) +"_dT_" + str(dT) + "_Dimension_" + str(D) + "_nmc_" + str(nmc) + "_nmceqstart_" + str(nmceqstart) + "_nmceq_" + str(nmceq)
